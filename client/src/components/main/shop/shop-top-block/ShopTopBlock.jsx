...
const BLOCK_HEIGHT = "600px";
const BACKGROUND_IMAGE = `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.3)), url(${fiddle})`;

const ShopTopBlock = () => {
  return (
    <div className={`bg-center md:bg-cover bg-fixed bg-no-repeat h-[${BLOCK_HEIGHT}] md:w-full`}
